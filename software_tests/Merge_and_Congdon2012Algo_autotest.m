...
for i = 1:9
    assert(abs(subjectSSRTs(i)-expectedSSRTs(i)) < 1e-10, ['Incorrect SSRT for subject ' num2str(i)]);
end
...
fprintf(['\n' method ':\n'])
subjectSSRTs = CalcSSRT_Congdon2012('Last', 'None', '2ndHalf', go_CorrectAnswer, go_Answer, go_GoRT, go_Correct, stop_SSD_actual, stop_Correct, stop_TrialComplete, go_TrialCounts, stop_TrialCounts);
assert(sum(isnan(subjectSSRTs(:))) == 0, 'No subjects should have been excluded');
...
fprintf(['\n' method ':\n'])
subjectSSRTs = CalcSSRT_Congdon2012('Last', 'Lenient', '2ndHalf', go_CorrectAnswer, go_Answer, go_GoRT, go_Correct, stop_SSD_actual, stop_Correct, stop_TrialComplete, go_TrialCounts, stop_TrialCounts);
assert(sum(isnan(subjectSSRTs(6:9))) == 4, 'Subjects 6-9 should be excluded under lenient criteria');
assert(sum(isnan(subjectSSRTs(1:5))) == 0, 'Subjects 1-5 should not be excluded under lenient criteria');
expectedSSRTs = [0.095, 0.0501, 0.0501, 0.1000, 0.1000, 0.1000, 0.1000, 0.1000, 0.0499];
for i = 1:5
...
fprintf(['\n' method ':\n'])
subjectSSRTs = CalcSSRT_Congdon2012('Last', 'Conservative', '2ndHalf', go_CorrectAnswer, go_Answer, go_GoRT, go_Correct, stop_SSD_actual, stop_Correct, stop_TrialComplete, go_TrialCounts, stop_TrialCounts);
assert(sum(isnan(subjectSSRTs(4:9))) == 6, 'Subjects 4-9 should have been excluded under conservative criteria');
assert(sum(isnan(subjectSSRTs(1:3))) == 0, 'Subjects 1-3 should not have been excluded under conservative criteria');
expectedSSRTs = [0.095, 0.0501, 0.0501, 0.1000, 0.1000, 0.1000, 0.1000, 0.1000, 0.0499];
for i = 1:3
...
fprintf(['\n' method ':\n'])
subjectSSRTs = CalcSSRT_Congdon2012('Average', 'None', '2ndHalf', go_CorrectAnswer, go_Answer, go_GoRT, go_Correct, stop_SSD_actual, stop_Correct, stop_TrialComplete, go_TrialCounts, stop_TrialCounts);
assert(sum(isnan(subjectSSRTs(:))) == 0, 'No subjects should have been excluded');
...
fprintf(['\n' method ':\n'])
subjectSSRTs = CalcSSRT_Congdon2012('Average', 'Lenient', '2ndHalf', go_CorrectAnswer, go_Answer, go_GoRT, go_Correct, stop_SSD_actual, stop_Correct, stop_TrialComplete, go_TrialCounts, stop_TrialCounts);
assert(sum(isnan(subjectSSRTs(6:9))) == 4, 'Subjects 6-9 should be excluded under lenient criteria');
assert(sum(isnan(subjectSSRTs(1:5))) == 0, 'Subjects 1-5 should not be excluded under lenient criteria');
expectedSSRTs = [0.0975, 0.0501, 0.0501, 0.1000, 0.1000, 0.1000, 0.1000, 0.1000, 0.0499];
for i = 1:5
...
fprintf(['\n' method ':\n'])
subjectSSRTs = CalcSSRT_Congdon2012('Average', 'Conservative', '2ndHalf', go_CorrectAnswer, go_Answer, go_GoRT, go_Correct, stop_SSD_actual, stop_Correct, stop_TrialComplete, go_TrialCounts, stop_TrialCounts);
assert(sum(isnan(subjectSSRTs(4:9))) == 6, 'Subjects 4-9 should have been excluded under conservative criteria');
assert(sum(isnan(subjectSSRTs(1:3))) == 0, 'Subjects 1-3 should not have been excluded under conservative criteria');
expectedSSRTs = [0.0975, 0.0501, 0.0501, 0.1000, 0.1000, 0.1000, 0.1000, 0.1000, 0.0499];
for i = 1:3
